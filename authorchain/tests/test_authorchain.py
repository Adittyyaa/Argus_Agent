"""
tests/test_authorchain.py
=========================
Comprehensive test suite for AuthorChain governance, ArmorIQ SDK client,
...
def temp_db(tmp_path):
    ...
    os.environ["AUTHORCHAIN_DB"] = db_file
    logger = AuditLogger(db_path=db_file)
    yield db_file, logger
    # Cleanup env
    if "AUTHORCHAIN_DB" in os.environ:
        del os.environ["AUTHORCHAIN_DB"]
