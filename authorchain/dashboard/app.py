...
dashboard/app.py
================
AuthorChain Interactive GUI Audit & Multi-Agent Swarm Control Center.
...
# Page Config
st.set_page_config(
    page_title="AuthorChain – ArmorIQ Personal Assistant Swarm",
    page_icon="🛡️",
    layout="wide",
...
# ── Main Header ──
st.title("🛡️ AuthorChain Control Center & Audit Dashboard")
st.markdown(
...
with tab4:
    st.subheader("📜 AuthorChain Architecture & Hackathon Presentation")
