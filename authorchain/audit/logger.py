...
audit/logger.py
===============
SQLite-backed audit logger for AuthorChain.
...
DB_PATH  = os.environ.get("AUTHORCHAIN_DB", os.path.join(_ROOT, "audit.db"))
...
class AuditLogger:
    ...
    def __init__(self, db_path: Optional[str] = None):
        self.db_path = db_path or os.environ.get("AUTHORCHAIN_DB", os.path.join(_ROOT, "audit.db"))
        self._init_db()
