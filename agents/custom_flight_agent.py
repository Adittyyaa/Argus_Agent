...
def main():
    print("✈️ [Custom Flight Agent] Starting with GUI configuration...")
    ...
    if os.path.exists(config_path):
        ...
        print(f"✈️ [Custom Flight Agent] Using custom route: {custom_args['origin']} → {custom_args['destination']}")
        print(f"✈️ [Custom Flight Agent] Passenger: {custom_args['passenger_name']}")
    else:
    ...
    try:
        ...
        print(f"✈️ [Custom Flight Agent] Searching flights: {custom_args['origin']} → {custom_args['destination']}")
        ...
        if "flights" in search_result and search_result["flights"]:
            ...
            print(f"✈️ [Custom Flight Agent] Found flight: {flight_id}")
            
            # Book the flight
            print(f"✈️ [Custom Flight Agent] Booking flight for {custom_args['passenger_name']}")
            ...
            print(f"✅ [Custom Flight Agent] Successfully completed booking!")
